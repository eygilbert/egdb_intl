...
Declare PtrSafe Function egdb_lookup_with_search Lib "egdb_intl64" (ByVal handle As Long, ByRef pos As Board, ByVal color As Long) As Long
Declare PtrSafe Function get_movelist Lib "egdb_intl64" (ByRef pos As Board, ByVal color As Long, ByRef movelist As Board) As Long
Declare PtrSafe Function is_capture Lib "egdb_intl64" (ByRef pos As Board, ByVal color As Long) As Boolean
Declare PtrSafe Function getdatabasesize_slice Lib "egdb_intl64" (ByVal nbm As Long, ByVal nbk As Long, ByVal nwm As Long, ByVal nwk As Long) As LongLong
Declare PtrSafe Sub indextoposition Lib "egdb_intl64" (ByVal index As LongLong, ByRef pos As Board, ByVal nbm As Long, ByVal nbk As Long, ByVal nwm As Long, ByVal nwk As Long)
Declare PtrSafe Function positiontoindex Lib "egdb_intl64" (ByRef pos As Board, ByVal nbm As Long, ByVal nbk As Long, ByVal nwm As Long, ByVal nwk As Long) As LongLong
Declare PtrSafe Function is_sharp_win Lib "egdb_intl64" (ByVal handle As Long, ByRef pos As Board, ByVal color As Long, ByRef sharp_move_pos As Board) As Boolean
Declare PtrSafe Function move_string Lib "egdb_intl64" (ByRef oldpos As Board, ByRef newpos As Board, ByVal color As Long, ByRef move As Byte) As Long
Declare PtrSafe Function positiontofen Lib "egdb_intl64" (ByRef pos As Board, ByVal color As Long, ByRef fen As Byte) As Long
Declare PtrSafe Function fentoposition Lib "egdb_intl64" (ByVal fen As String, ByRef pos As Board, ByRef color As Long) As Long
